...
?>
<body>
    <div class="container py-xl bg-gray-100 bg-opacity-75">
        <section class="text-gray-600 body-font" style="background-image: url('images/hero-img.jpg'); filter: blur(4px);">
            <div class="container py-24 mx-auto">
                <div class="flex flex-col sm:items-center items-start mx-auto">
                    <h1 class="flex-grow  text-6xl font-medium title-font text-black-1000">Pylon Coorporation Error Tracker</h1>
                </div>
            </div>
        </section>
        <?php
       ...
       <section class="text-gray-600 body-font pb-20">
        <div class="container px-5 py-24 mx-auto">
            <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
                <h1 id="greeting" class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Please log in or register to use this site.</h1>
                <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">
                    The only purpose of this website is just to get my mark on my Webprogramming II course. 
                </p>
            </div>`; 
